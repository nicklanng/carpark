...
func _001_create_events_tableUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "001_create_events_table.up.sql", size: 142, mode: os.FileMode(420), modTime: time.Unix(1519253160, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
